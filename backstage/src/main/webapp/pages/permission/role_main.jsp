...
<div class="panel-body">
    <table class="table table-bordered table-striped" cellspacing="0" width="100%">
        ...
        <tbody>
            <c:forEach items="${pageList.datas }" var="role" varStatus="status">
                <tr>
                    <td>${role.name }</td>
	                <td>${role.code }</td>
	                <td>
	                ...
	                <td>
	                   ...
	                   <c:if test="${role.disabled==1 }">
                            <a href="javascript:permission.role.onOrOff('${role.id }','0','${pageList.page.currentPage }');">启用</a>
                       </c:if>
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${pageList.page.hasPrev}">
                                <li><a href="javascript:permission.role.pageQuery('${pageList.page.prevPage }')">&lt;</a></li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li><a href="javascript:permission.role.pageQuery('1')">1</a></li>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <c:if test="${pageList.page.currentPage>2}">
                            <li><a href="javascript:permission.role.pageQuery('${pageList.page.prevPage }')">${pageList.page.prevPage }</a></li>
                        </c:if>
                        ...
                        <c:if test="${pageList.page.totalPage-pageList.page.currentPage>1}">
                            <li><a href="javascript:permission.role.pageQuery('${pageList.page.nextPage }')">${pageList.page.nextPage }</a></li>
                        </c:if>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${pageList.page.totalPage>1}">
                                <li><a href="javascript:permission.role.pageQuery('${pageList.page.totalPage }')">${pageList.page.totalPage }</a></li>
                            </c:when>
                        </c:choose>
                        <c:choose>
                            <c:when test="${pageList.page.hasNext}">
                                <li><a href="javascript:permission.role.pageQuery('${pageList.page.nextPage }')">&gt;</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="javascript:void(0)">&gt;</a></li>
                            </c:otherwise>
