...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <button type="button" class="btn btn-primary" onclick="javascript:notice.addNotice()" style="margin-bottom:0">新增</button>
        </div>
    </div>
    <div class="panel-body">
        <table id="notice-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>公告标题</th>
                    <th>发布时间</th>
		                ...
		                <ul class="pagination">
		                    <c:choose>
		                        <c:when test="${pageList.page.hasPrev}">
		                            <li><a href="javascript:notice.getNoticeList(${pageList.page.prevPage })">&lt;</a></li>
		                        </c:when>
		                        <c:otherwise>
		                    ...
		                    <c:choose>
		                        ...
		                        <c:otherwise>
		                            <li><a href="javascript:notice.getNoticeList(1)">1</a></li>
		                        </c:otherwise>
		                    </c:choose>
		                    ...
		                    <c:if test="${pageList.page.currentPage>2}">
		                        <li><a href="javascript:notice.getNoticeList(${pageList.page.prevPage })">${pageList.page.prevPage }</a></li>
		                    </c:if>
		                    ...
		                    <c:if test="${pageList.page.totalPage-pageList.page.currentPage>1}">
		                        <li><a href="javascript:notice.getNoticeList(${pageList.page.nextPage })">${pageList.page.nextPage }</a></li>
		                    </c:if>
		                    ...
		                    <c:choose>
		                        ...
		                        <c:when test="${pageList.page.totalPage>1}">
		                            <li><a href="javascript:notice.getNoticeList(${pageList.page.totalPage })">${pageList.page.totalPage }</a></li>
		                        </c:when>
		                    </c:choose>
		                    <c:choose>
		                        <c:when test="${pageList.page.hasNext}">
		                            <li><a href="javascript:notice.getNoticeList(${pageList.page.nextPage })">&gt;</a></li>
		                        </c:when>
		                        <c:otherwise>
		                            <li><a href="javascript:void(0)">&gt;</a></li>
		                        </c:otherwise>
...
<div class="modal fade bs-example-modal-lg" id="notice-editModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
