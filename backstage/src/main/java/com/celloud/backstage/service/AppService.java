...
public interface AppService {
    ...
    public int addApp(App app, String[] screenNames, Integer[] formatIds,
            Integer[] calssifyIds);

    public int updateApp(App app, String[] screenNames, String[] delScreenNames,
            Integer[] formatIds, Integer[] calssifyIds);
