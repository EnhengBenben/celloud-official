...
<div class="col-xs-12" style="height: 350px;" id="userechartView"></div>
	...
	<tbody>
		<c:if test="${dataList!=null">
			 <c:forEach items="${dataList }" var="data">
				<tr>
					<td>
						<a href="javascript:monthDataList(${data.user_id },'${data.yearMonth }');">${data.yearMonth }</a>
					</td>
					<td>${data.fileNum }</td>
				</tr>
			</c:forEach>
