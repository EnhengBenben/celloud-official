...
<div>
	...
	<div id="nomal" style="display: none;">
		...
		<c:if test="${not hbv.type.equals('no match<br />') }">
			...
			<div id="printDiv1">
				<div class="m-box">
				 	<h2>
				 		1.替诺福韦酯TDF突变检测
				 		<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',0,1)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
				 	</h2>
				    <div class="m-boxCon">
				...
				<div class="m-box">
				 	<h2>2.替比夫定 LDT 突变检测
				 		<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',0,2)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
				 	</h2>
				    <div class="m-boxCon">
				    	<c:if test="${hbv.known.containsKey('204_png') }">
				...
				<div class="m-box">
				 	<h2>3.阿德福韦 ADV 突变检测
				 		<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',0,3)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
				 	</h2>
				    <div class="m-boxCon">
				...
				<div class="m-box">
				 	<h2>4.拉米夫定 LAM 突变检测
				 		<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',0,4)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
				 	</h2>
				    <div class="m-boxCon">
				...
				<div class="m-box">
				 	<h2>5.恩曲他滨 FTC 突变检测
				 		<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',0,5)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
				 	</h2>
				    <div class="m-boxCon">
					    <c:if test="${hbv.known.containsKey('173_png') }">
							<a href="javascript:showBgOne('${uploadPath}${hbv.userId }/${hbv.appId }/${hbv.dataKey }/SVG/${hbv.known['173_10_png'] }');" >
				...
				<div class="m-box">
				 	<h2>6.恩替卡韦 ETV 突变检测
				 		<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',0,6)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
				 	</h2>
				    <div class="m-boxCon">
				...
				<div class="m-box">
				 	  <h2>7.其他突变位点（该位点目前没有已发表文献支持，无明确临床意义）
				 	  	<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',0,7)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
				 	  </h2>
		...
		<div class="m-box">
		 	  ...
		 	  <span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',2)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
		 	  </h2>
		...
		<div class="m-box" id="printDiv3">
			<h2><i class="i-dna"></i>原始峰图
				<span style="float:right;padding-right: 30px;padding-top: 8px;" title="帮助" onclick="showModal('helpModal',1)"><div class="clear button button-glow button-circle button-rounded button-primary button-tiny"><span class="fa fa-thumbs-up"></span></div></span>
			</h2>
