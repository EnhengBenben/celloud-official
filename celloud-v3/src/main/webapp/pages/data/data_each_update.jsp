...
<div class="form-group">
	...
	<div class="col-xs-9" id="dataTag">
		<span id="dataMoreInfoStrainSpan">
			<input id="data-strain-hide" type="hidden" name="data.strain" value="${data.strain}" style="width: 270px;" readonly="readonly"/>
		</span>
 	</div>
</div>
<div id="update-data-error" class="alert alert-warning-cel alert-dismissable hide">
