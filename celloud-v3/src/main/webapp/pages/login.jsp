			...
			<form action="login" method="post" id="loginForm">
				<div class="main clearfix">
					...
					<input type="password" class="pwd" placeholder="密码" id="password"
						value="${fn:substring(requestScope.password,0,16)}" />
					<input type="hidden" id="password1"
						value="${fn:substring(requestScope.password,16,requestScope.password.length())}">
					...
					.ready(
							function() {
								if (!isPlaceholder()) {
									...
									pwdField
											.after('<input id="pwdPlaceholder" type="text" class="pwd" value='+pwdVal+' autocomplete="off" />');
