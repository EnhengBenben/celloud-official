...
<html lang="en">
<head>
<title>Random Protein Regions</title>
...
<script type="text/javascript" src="js/random_protein_regions.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = randomProteinRegions(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/Random Protein Regions.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Random Protein Regions</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Random Protein Regions replaces regions of a protein sequence with random residues. Random sequences can be used to evaluate the significance of sequence analysis results.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
