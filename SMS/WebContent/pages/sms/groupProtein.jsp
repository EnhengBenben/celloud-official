...
<script type="text/javascript" src="js/group_protein.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = groupProtein(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/Group Protein.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Group Protein</a>
			...
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
                      ...
                      </select> and show <select class="span3">
                        <option value="100">
                          100
                        </option>
                        <option value="90">
