...
<html lang="en">
<head>
<title>Pairwise Align DNA</title>
...
<script type="text/javascript" src="js/pairwise_align_dna.js"></script>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				if((!reference)||($.trim(reference)=="")){
					...
					clearWarn();
					try{
						var result = pairwiseAlignDna(document);
						$("#result").html(result);
						$("#show").css("display","");
					} catch(e) {
		...
		$("#random").click(function(){
			...
			$.get("data/Pairwise Align DNA.fa","",function(data){
				$("textarea[name='sequence']").val(data);
			});
			$.get("data/Pairwise Align DNA1.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Pairwise Align DNA</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Pairwise Align DNA accepts two DNA sequences and determines the optimal global alignment. Use Pairwise Align DNA to look for conserved sequence regions.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
