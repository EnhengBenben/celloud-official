...
<script type="text/javascript" src="js/mutate_protein.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = mutateProtein(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/Mutate Protein.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Mutate Protein</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Mutate Protein introduces residue changes into a protein sequence. You can select the number of mutations to introduce, and whether or not to preserve the first residue in the sequence, to reflect selection acting to maintain a start codon. The position of each mutation is chosen randomly, and multiple mutations can occur at a single site. Mutated sequences can be used to evaluate the significance of sequence analysis results.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
					  ...
					  Introduce <input type="text" class="input-xlarge" value="10" />mutations into each sequence.<br/>
					  The first residue in each sequence <select class="span3">
                        <option value="0">
                          can
                        </option>
