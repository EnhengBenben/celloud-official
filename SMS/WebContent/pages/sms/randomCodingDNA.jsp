...
<script type="text/javascript" src="js/random_coding_dna.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = randomCodingDna(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Random Coding DNAs</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Random Coding DNA generates a random open reading frame beginning with a start codon and ending with a stop codon. You can choose the genetic code to use and the length of the sequence to generate. Random sequences can be used to evaluate the significance of sequence analysis results.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				Enter the length of the sequence (in codons) in the text area below. Maximum accepted value is 4000.
				<p> 
