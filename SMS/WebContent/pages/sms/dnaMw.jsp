...
<script type="text/javascript" src="js/dna_mw.js"></script>
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/dnaMw.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">DNA Molecular Weight</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> DNA Molecular Weight accepts one or more DNA sequences and calculates molecular weight. Sequences can be treated as double-stranded or single-stranded, and as linear or circular. Single-stranded sequences are assumed to have a 5' phosphate. Use DNA Molecular Weight when calculating molecule copy number.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
