...
function pairwiseAlignCodons (theDocument) {	
	...
	result += getPairwiseAlignTitle(titleOne, newCodonsOne, titleTwo, newCodonsTwo);
	...
	result += pairwiseCodon (titleOne, newCodonsOne, titleTwo, newCodonsTwo, MATRIX, GAP_PENALTY, BEGIN_GAP_PENALTY, END_GAP_PENALTY);
	return result;
}	
