...
function colorAlignProp (theDocument) {
	...
	result += "<span class=\"g\">" + "G, A, V, L, I" + "</span><br/>";
	result += "<span class=\"f\">" + "F, Y, W" + "</span><br/>";
	result += "<span class=\"c\">" + "C, M" + "</span><br/>";
	result += "<span class=\"s\">" + "S, T" + "</span><br/>";
	result += "<span class=\"k\">" + "K, R, H" + "</span><br/>";
	result += "<span class=\"d\">" + "D, E" + "</span><br/>";
	result += "<span class=\"q\">" + "N, Q" + "</span><br/>";
	result += "<span class=\"p\">" + "P" + "</span><br/>";
	result += "<br/>";
	result += colorAlign (titleArray, sequenceArray, theDocument.forms[0].elements[4].options[theDocument.forms[0].elements[4].selectedIndex].value, theDocument.forms[0].elements[5].options[theDocument.forms[0].elements[5].selectedIndex].value, arrayOfGroups, theDocument.forms[0].elements[7].value, longestTitle);
	return result;
}
