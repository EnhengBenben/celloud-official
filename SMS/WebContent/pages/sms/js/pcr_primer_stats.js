...
function pcrPrimerStats (theDocument) {	
	...
	result += "Global settings:<br/>";
	if (isPhosphorylated) {
		result += "-The primers have a 5'-phosphate group.<br/>";
	}
	else {
		result += "-The primers do not have a 5'-phosphate group.<br/>";
	}
	result += "-Combined concentration of K+ and Na+ in the reaction = " + milliMolarSalt + " millimolar.<br/>";
	result += "-Mg+2 concentration in the reaction = " + milliMolarMagnesium + " millimolar.<br/>";
	result += "-Primer concentration in the reaction = " + nanoMolarPrimerTotal + " nanomolar.<br/>";
	result += '<br/>';
	result += '------------------------------------------------------------<br/>';
	...
	for (var i = 0; i < arrayOfFasta.length; i++)	{
		...
		result += '------------------------------------------------------------<br/>';
		result += 'General properties:<br/>';
		result += '-------------------<br/>';
		result += rightNum("Primer name:", "", 32, "") + title + "<br/>";
		result += rightNum("Primer sequence:", "", 32, "") + newDna + "<br/>";
		result += rightNum("Sequence length:", "", 32, "") + newDna.length + "<br/>";
		result += rightNum("Base counts:", "", 32, "") + _baseCounts(newDna) + "<br/>";
		result += rightNum("GC content (%):", "", 32, "") + percentGC + "<br/>";
		result += rightNum("Molecular weight (Daltons):", "", 32, "") + _molecularWeight(newDna, isPhosphorylated) + "<br/>";
		result += rightNum("nmol/A260:", "", 32, "") + _nmolPerA260(newDna) + "<br/>";
		result += rightNum("micrograms/A260:", "", 32, "") + _microgramsPerA260(newDna, isPhosphorylated) + "<br/>";
		result += rightNum("Basic Tm (degrees C):", "", 32, "") + _basicTm(newDna) + "<br/>";
		result += rightNum("Salt adjusted Tm (degrees C):", "", 32, "") + _molarSaltAdjustedTm(newDna, molarSalt) + "<br/>";
		result += rightNum("Nearest neighbor Tm (degrees C):", "", 32, "") + nearestNeighborTm + "<br/>";
		
		result += '<br/>';
		result += 'PCR suitability tests (Pass / Warning):<br/>';
		result += '------------------------------------<br/>';			
		result += rightNum("Single base runs:", "", 32, "") + _getBaseRunsReport(newDna, 5) + "<br/>";
		result += rightNum("Dinucleotide base runs:", "", 32, "") + _getDiNucleotideRunsReport(newDna, 5) + "<br/>";
		result += rightNum("Length:", "", 32, "") + _getSuitableLengthReport(newDna, 14, 30) + "<br/>";
		result += rightNum("Percent GC:", "", 32, "") + _getSuitableGCReport(newDna, percentGC, 40, 60) + "<br/>";
		result += rightNum("Tm (Nearest neighbor):", "", 32, "") + _getSuitableTmReport(newDna, nearestNeighborTm, 50, 58) + "<br/>";
		result += rightNum("GC clamp:", "", 32, "") + _getSuitableThreePrimeGC(newDna, 1, 3) + "<br/>";
		result += rightNum("Self-annealing:", "", 32, "") + selfCompHash['report'] + "<br/>";
		if (selfCompHash['report'] != "Pass") {
			result += rightNum(":", "", 32, "") + selfCompHash['upper'] + "<br/>";
			result += rightNum(":", "", 32, "") + selfCompHash['divider'] + "<br/>";
			result += rightNum(":", "", 32, "") + selfCompHash['lower'] + "<br/>";
		}
		result += rightNum("Hairpin formation:", "", 32, "") + hairpinHash['report'] + "<br/>";
		if (hairpinHash['report'] != "Pass") {
			result += rightNum(":", "", 32, "") + hairpinHash['upper']  + "<br/>";
			result += rightNum(":", "", 32, "") + hairpinHash['divider'] + "<br/>";
			result += rightNum(":", "", 32, "") + hairpinHash['lower'] + "<br/>";
		}
		result += '------------------------------------------------------------<br/>';
		result += '<br/>';
	}
