...
<html lang="en">
<head>
<title>EMBL Trans Extractor</title>
...
<script type="text/javascript" src="js/embl_trans.js"></script>
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/emblFeat.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">EMBL Trans Extractor</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> EMBL Trans Extractor accepts an EMBL file as input and returns each of the protein translations described in the file in FASTA format. EMBL Trans Extractor can be used when you are more interested in the predicted protein translations of a DNA sequence than the DNA sequence itself.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
