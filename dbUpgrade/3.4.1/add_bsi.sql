...
INSERT INTO `tb_app` (`app_name`, `english_name`, `address`, `picture_name`, `create_date`, `intro`, `description`, `company_id`, `attribute`, `run_type`, `flag`, `run_data`, `data_num`, `param`, `app_doc`, `off_line`, `command`, `title`, `method`, `max_task`, `code`) VALUES ('百菌探-腹水', 'ASB', NULL, 'bactive.png', '2016-12-26 16:07:23', '血流感染-腹水', '', 45, 1, 1, 0, 0, 1, 0, NULL, 0, 'nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/moniter_spark.pl nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/spark_BSI.pl ${list} ${path} ProjectID${projectId} &>${path}${projectId}.log &', 'dataKey	文件名称	种	属比对上的序列数	种序列百分比', 'MIB', 0, 'BSI');
INSERT INTO `tb_app` (`app_name`, `english_name`, `address`, `picture_name`, `create_date`, `intro`, `description`, `company_id`, `attribute`, `run_type`, `flag`, `run_data`, `data_num`, `param`, `app_doc`, `off_line`, `command`, `title`, `method`, `max_task`, `code`) VALUES ('百菌探-脑脊液', 'CFB', NULL, 'bactive.png', '2016-12-26 16:07:23', '血流感染-脑脊液', '', 45, 1, 1, 0, 0, 1, 0, NULL, 0, 'nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/moniter_spark.pl nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/spark_BSI.pl ${list} ${path} ProjectID${projectId} &>${path}${projectId}.log &', 'dataKey	文件名称	种	属比对上的序列数	种序列百分比', 'MIB', 0, 'BSI');
INSERT INTO `tb_app` (`app_name`, `english_name`, `address`, `picture_name`, `create_date`, `intro`, `description`, `company_id`, `attribute`, `run_type`, `flag`, `run_data`, `data_num`, `param`, `app_doc`, `off_line`, `command`, `title`, `method`, `max_task`, `code`) VALUES ('百菌探-阴道拭子', 'VSB', NULL, 'bactive.png', '2016-12-26 16:07:23', '血流感染-阴道拭子', '', 45, 1, 1, 0, 0, 1, 0, NULL, 0, 'nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/moniter_spark.pl nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/spark_BSI.pl ${list} ${path} ProjectID${projectId} &>${path}${projectId}.log &', 'dataKey	文件名称	种	属比对上的序列数	种序列百分比', 'MIB', 0, 'BSI');
INSERT INTO `tb_app` (`app_name`, `english_name`, `address`, `picture_name`, `create_date`, `intro`, `description`, `company_id`, `attribute`, `run_type`, `flag`, `run_data`, `data_num`, `param`, `app_doc`, `off_line`, `command`, `title`, `method`, `max_task`, `code`) VALUES ('百菌探-尿', 'URB', NULL, 'bactive.png', '2016-12-26 16:07:23', '血流感染-尿', '', 45, 1, 1, 0, 0, 1, 0, NULL, 0, 'nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/moniter_spark.pl nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/spark_BSI.pl ${list} ${path} ProjectID${projectId} &>${path}${projectId}.log &', 'dataKey	文件名称	种	属比对上的序列数	种序列百分比', 'MIB', 0, 'BSI');
INSERT INTO `tb_app` (`app_name`, `english_name`, `address`, `picture_name`, `create_date`, `intro`, `description`, `company_id`, `attribute`, `run_type`, `flag`, `run_data`, `data_num`, `param`, `app_doc`, `off_line`, `command`, `title`, `method`, `max_task`, `code`) VALUES ('百菌探-水', 'WAB', NULL, 'bactive.png', '2016-12-26 16:07:23', '血流感染-水', '', 45, 1, 1, 0, 0, 1, 0, NULL, 0, 'nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/moniter_spark.pl nohup perl /share/biosoft/perl/wangzhen/16s-meta-pipeline/spark_BSI.pl ${list} ${path} ProjectID${projectId} &>${path}${projectId}.log &', 'dataKey	文件名称	种	属比对上的序列数	种序列百分比', 'MIB', 0, 'BSI');
