...
<div>
	...
	<div class="m-file">
	    <dl class="dl-horizontal datareport-title">
          ...
          <dt>文件名称：</dt>
          <dd class="force-break"><s:property value="resultMap.fileName"/>(<s:property value="%{resultMap.pagePath.replace('/SVG','').substring(resultMap.pagePath.replace('/SVG','').lastIndexOf('/')+1,resultMap.pagePath.replace('/SVG','').length())}"/>)</dd>
        </dl>
	</div>
	<div class="m-box">
