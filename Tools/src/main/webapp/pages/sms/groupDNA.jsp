...
<script type="text/javascript" src="js/group_dna.js"></script>
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/Group DNA.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Group DNA</a>
			...
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
					    ...
					    Use a group size of <select class="span3">
                      ...
                      </select> and display <select class="span3">
                        <option value="100">
                          100
                        </option>
                        <option value="90">
                      ...
                      </select> the reverse strand.<br/>
                      Show numbering <select class="span3">
                      ...
                      Start the numbering at <input type="text"  class="input-xlarge" value="1" />
                  </form>
				</p>
			</div>
		</div>
