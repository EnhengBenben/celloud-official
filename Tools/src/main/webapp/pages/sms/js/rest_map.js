...
function restMap (theDocument) {
	...
	for (var i = 0; i < arrayOfFasta.length; i++)	{
		...
		result += getInfoFromTitleAndSequenceAndTopology(title, newDna, theDocument.forms[0].elements[7].options[theDocument.forms[0].elements[7].selectedIndex].value);
		...
		result += layoutRestTrans (newDna, geneticCode, restrictionSiteCollection, theDocument.forms[0].elements[4].options[theDocument.forms[0].elements[4].selectedIndex].value, theDocument.forms[0].elements[5].options[theDocument.forms[0].elements[5].selectedIndex].value);
		
		result += '<br/>';
				
		result += writeRestrictionSites (newDna, restrictionSites, theDocument.forms[0].elements[7].options[theDocument.forms[0].elements[7].selectedIndex].value);
		result += '<br /><br/><br /><br/>';
	}
	return result;
}	
