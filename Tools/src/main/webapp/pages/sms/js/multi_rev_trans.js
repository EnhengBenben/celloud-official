...
function multiRevTrans (theDocument) {	
	...
	for (var i = 0; i < titleArray.length; i++)	{
		result += getInfoFromTitleAndSequence(titleArray[i], sequenceArray[i]);
		if (i < titleArray.length - 1) {
			result += "<div class=\"info\">Combined with:</div><br/>";
		}	
	}
	result += writeConsensusSeq(sequenceArray, codonTable);
	result += "<br/>";
	result += writeMultiRevTrans(sequenceArray, codonTable);
	return result;
}
...
function writeConsensusSeq(sequenceArray, codonTable) {
	...
	result += '&gt;' + 'reverse translation of alignment to a ' + consensusSeq.length + ' base sequence of consensus codons.<br/>';
	result += addReturns(consensusSeq.join(""));
	result += "<br/>";
	return result;
}
...
function writeMultiRevTrans(sequenceArray, codonTable) {
	...
	for (var i = 0; i < sequenceArray[0].length; i++)	{
		...
		result += "<b>" + (i + 1) + "_" + columnSeq + "_" + "first</b><br/>";
		result += "g" + markG.substring(0, firstG) + " " + (firstG / markLength).toFixed(2) + "<br/>" + "a" + markA.substring(0, firstA) + " " + (firstA / markLength).toFixed(2) + "<br/>" + "T" + markT.substring(0, firstT) + " " + (firstT / markLength).toFixed(2) + "<br/>" + "C" + markC.substring(0, firstC) + " " + (firstC / markLength).toFixed(2) + "<br/>";


		result += "<b>" + (i + 1) + "_" + columnSeq + "_" + "second</b><br/>";
		result += "g" + markG.substring(0, secondG) + " " + (secondG / markLength).toFixed(2) + "<br/>" + "a" + markA.substring(0, secondA) + " " + (secondA / markLength).toFixed(2) + "<br/>" + "T" + markT.substring(0, secondT) + " " + (secondT / markLength).toFixed(2) + "<br/>" + "C" + markC.substring(0, secondC) + " " + (secondC / markLength).toFixed(2) + "<br/>";

		result += "<b>" + (i + 1) + "_" + columnSeq + "_" + "third</b><br/>";
		result += "g" + markG.substring(0, thirdG) + " " + (thirdG / markLength).toFixed(2) + "<br/>" + "a" + markA.substring(0, thirdA) + " " + (thirdA / markLength).toFixed(2) + "<br/>" + "T" + markT.substring(0, thirdT) + " " + (thirdT / markLength).toFixed(2) + "<br/>" + "C" + markC.substring(0, thirdC) + " " + (thirdC / markLength).toFixed(2) + "<br/>";
