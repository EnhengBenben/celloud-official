...
function primerMap (theDocument) {	
	...
	if (theDocument.forms[0].elements[8].options[theDocument.forms[0].elements[8].selectedIndex].value == "shown") {
		...
		result += "<br/>";
		result += "<span class=\"forward_primer\">" + "&gt;&gt;&gt;forward primer" + "</span><br /><br/>";
		result += "<span class=\"reverse_primer\">" + "&lt;&lt;&lt;reverse primer" + "</span><br /><br/>";
		result += "<br/>";	
	}			
	...
	for (var i = 0; i < arrayOfFasta.length; i++)	{
		...
		result += getInfoFromTitleAndSequenceAndTopology(title, newDna, theDocument.forms[0].elements[9].options[theDocument.forms[0].elements[9].selectedIndex].value);
		if (theDocument.forms[0].elements[8].options[theDocument.forms[0].elements[8].selectedIndex].value == "shown") {
		...
		result += layoutPrimerMap (newDna, geneticCode, restrictionSiteCollection, forwardMatches, reverseMatches, theDocument.forms[0].elements[5].options[theDocument.forms[0].elements[5].selectedIndex].value, theDocument.forms[0].elements[6].options[theDocument.forms[0].elements[6].selectedIndex].value);
		result += '<br/>';
		//this is a summary of the sites.
		if (theDocument.forms[0].elements[8].options[theDocument.forms[0].elements[8].selectedIndex].value == "shown") {				
			result += writeRestrictionSites (newDna, restrictionSites, theDocument.forms[0].elements[9].options[theDocument.forms[0].elements[9].selectedIndex].value);
			result += '<br /><br/>';	
		}
		//write summary of primers
		result += writePrimerSites(newPrimers);		
		result += '<br /><br/><br /><br/>';
...
function writePrimerSites (primers) {
	var result = "";
	var backGroundClass;
	result += '<table border="1" width="100%" cellspacing="0" cellpadding="2"><tbody><br/>';	
	result += '<tr><td class="title" width="200px">' + 'Primer:' + '</td><td class="title">' + 'Sequence:' + '</td></tr><br/>';	
	for (var i = 0; i < (primers.length); i++)	{
		...
		result += '<tr><td class="' + backGroundClass + '">' + primers[i].name + '</td><td class="' + backGroundClass + '">' + '5\'-' + primers[i].sequence  + '-3\'' + '</td></tr><br/>';
	}
...
function layoutPrimerMap (dnaSequence, geneticCode, restrictionSiteCollection, forwardMatches, reverseMatches, basesPerLine, readingFrame)	{
	...
	for (var i = 0; i < dnaSequence.length; i = i + basesPerLine) {
		if (restrictionSiteCollection != null) {
		    ...
		    for (var j = 0; j < sitesInRange.length; j++) {
			    ...
			    if (sitesInRange[j].numberOfCuts == 1) {
			    		result += spaceString.substring(0, sitesInRange[j].position - i + 9) + "<span class=\"one\">" + sitesInRange[j].label + "</span><br/>";
			    }
			    else if (sitesInRange[j].numberOfCuts == 2) {
			    	result += spaceString.substring(0, sitesInRange[j].position - i + 9) + "<span class=\"two\">" + sitesInRange[j].label + "</span><br/>";
			    }
			    else if (sitesInRange[j].numberOfCuts == 3) {
			    	result += spaceString.substring(0, sitesInRange[j].position - i + 9) + "<span class=\"three\">" + sitesInRange[j].label + "</span><br/>";
			    }
			    else {
			    	result += spaceString.substring(0, sitesInRange[j].position - i + 9) + sitesInRange[j].label + "<br/>";
			    }
		    }
		}
		...
		for (var j = 0; j < sitesInRange.length; j++) {
			//9 is added because of indent to dna sequence
			result += spaceString.substring(0, sitesInRange[j].position - i + 9) + "<span class=\"forward_primer\">" + "&gt;&gt;&gt;" + sitesInRange[j].primerName + "&gt;&gt;&gt;" + " " + (sitesInRange[j].position + 1) + " to " + sitesInRange[j].end + "</span><br/>";
		}
		...
		for (var j = 0; j < sitesInRange.length; j++) {
			//9 is added because of indent to dna sequence
			result += spaceString.substring(0, sitesInRange[j].position - i + 9) + "<span class=\"reverse_primer\">" + "&lt;&lt;&lt;" + sitesInRange[j].primerName + "&lt;&lt;&lt;" + " " + (sitesInRange[j].position + 1) + " to " + sitesInRange[j].end + "</span><br/>";
		}		
