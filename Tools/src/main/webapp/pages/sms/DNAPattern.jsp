...
<script type="text/javascript" src="js/dna_pattern.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = dnaPattern(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/DNAPattern.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">DNA Pattern Find</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> DNA Pattern Find accepts one or more sequences along with a search pattern and returns the number and positions of sites that match the pattern. Use DNA Pattern Find to locate sequence regions that match a consensus sequence of interest.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
