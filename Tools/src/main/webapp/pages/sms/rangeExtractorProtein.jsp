...
<html lang="en">
<head>
<title>Range Extractor Protein</title>
...
function clearWarn(){
	...
	$(document).ready(function(){
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/rangeExtractorProtein.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Range Extractor Protein</a>
			...
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
                    	...
                    	<input type="text" class="input-xlarge" value="1, 5, 10..12" /><br />
