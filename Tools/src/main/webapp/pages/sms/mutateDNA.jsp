	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Mutate DNA</a>
			...
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
					  ...
					  The first three bases in each sequence
					   <select class="span3">
                        <option value="0">
                          can
                        </option>
                      ...
                      </select> be mutated.<br/>
                      The last three bases in each sequence 
                      <select class="span3">
