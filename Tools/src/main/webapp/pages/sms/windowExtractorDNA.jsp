...
<html lang="en">
<head>
<title>Window Extractor DNA</title>
...
<script type="text/javascript" src="js/window_extract_dna.js"></script>
...
function clearWarn(){
	...
	$(document).ready(function(){
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/windowExtractorDNA.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Window Extractor DNA</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Window Extractor DNA accepts a DNA sequence along with a window position and window size. The bases corresponding to the window are returned, either as a new sequence, as uppercase text, or as lowercase text. Use Window Extractor DNA to obtain subsequences using position information.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
	                    ...
	                    Extract a window of size <input type="text" class="input-xlarge" value="61" />
	                    <select class="span3">
                        ...
                        position<input type="text" class="input-xlarge" value="50" /><br />
	                    <div class="alert laert-warning" id="warning"></div>
	                    ...
	                    Obtain bases from the <select class="span3">
