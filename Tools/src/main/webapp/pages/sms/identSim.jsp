...
<script type="text/javascript" src="js/ident_sim.js"></script>
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/identSim.fa","",function(data){
				$("textarea[name='sequence']").val(data);
			});
			$.get("data/identSim1.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Ident and Sim</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Ident and Sim accepts a group of aligned sequences (in FASTA or GDE format) and calculates the identity and similarity of each sequence pair. Identity and similarity values are often used to assess whether or not two sequences share a common ancestor or function.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
                    	...
                    	Enter the groups of similar amino acids separated by commas to be used for the similarity calculation. If you are comparing DNA sequences, leave this text area empty.<br />
                    	<textarea name="reference" class="span9" rows="6"></textarea><br /><br />
