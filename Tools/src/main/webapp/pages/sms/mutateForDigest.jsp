...
<script type="text/javascript" src="js/mutate_for_digest.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = mutateForDigest(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/mutateForDigest.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Mutate for Digest</a>
     ...
     <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong>Mutate for Digest accepts a DNA sequence as input and searches for regions that can easily be mutated to create a restriction site of interest. The program also displays protein translations so that you can see which reading frames are altered by the proposed mutations. Use Mutate for Digest to find sequences that can be converted to a useful restriction site using PCR or site-directed mutagenesis.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				Paste a raw sequence or one or more FASTA sequences into the text area below. Input limit is 10000 characters.
				<p> 
					<form action="" name="main_form" id="main_form">
					    ...
					    Search for future <select class="span3">
                        ...
                        <option value="/cycgrg/ (AvaI c|ycgrg)5">
                          AvaI c|ycgrg
                        </option>
                        ...
                        <option selected="selected" value="/ggatcc/ (BamHI g|gatcc)5">
                          BamHI g|gatcc
                        </option>
                        ...
                        <option value="/gtyrac/ (HincII gty|rac)3">
                          HincII gty|rac
                        </option>
                        ...
                        <option value="/gantc/ (HinfI g|antc)4">
                          HinfI g|antc
                        </option>
                        ...
                        <option value="/ngatcn/ (MboI |gatc)5">
                          MboI |gatc
                        </option>
