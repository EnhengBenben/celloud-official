...
<script type="text/javascript" src="js/split_codons.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = splitCodons(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/splitCodons.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Split Codons</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Split Codons divides a coding sequence into three new sequences, each consisting of the bases from one of the three codon positions. For example, the sequence "ATGATGATG" is converted to "AAA", "TTT", and "GGG". Split Codons can be useful when you wish to analyze codon positions separately in downstream analyses.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
