...
<html lang="en">
<head>
<title>GenBank Trans Extractor</title>
...
<script type="text/javascript" src="js/genbank_trans.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = genbankTrans(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/genBankTrans.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">GenBank Trans Extractor</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> GenBank Trans Extractor accepts a GenBank file as input and returns each of the protein translations described in the file in FASTA format. GenBank Trans Extractor should be used when you are more interested in the predicted protein translations of a DNA sequence than the DNA sequence itself.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				Paste the contents of one or more GenBank files into the text area below. Input limit is 200000 characters.
				<p> 
					<form action="" name="main_form" id="main_form">
					    ...
					    <input type="button" value="random" id="random" class="btn"/>
                  </form>
				</p>
			</div>
		</div>
