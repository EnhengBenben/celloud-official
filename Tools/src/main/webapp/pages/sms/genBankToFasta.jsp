...
<script type="text/javascript" src="js/genbank_fasta.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = genbankFasta(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/genBankToFasta.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">GenBank to FASTA</a>
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> EMBL Feature Extractor accepts an EMBL file as input and reads the sequence feature information described in the feature table.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
