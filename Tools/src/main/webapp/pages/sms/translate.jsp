	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = translateDna(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/Translate.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Translate</a>
     ...
     <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong>Translate accepts a DNA sequence and converts it into a protein in the reading frame you specify. Translate supports the entire IUPAC alphabet and several genetic codes.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
					   ...
					   Translate in <select class="span3">
                      ...
                      </select> <a href="genetic_code.html">genetic code</a>.
                  </form>
				</p>
			</div>
		</div>
