...
<html lang="en">
<head>
<title>Fuzzy Search Protein</title>
...
<script type="text/javascript" src="js/fuzzy_search_protein.js"></script>
	...
	$(document).ready(function(){
		...
		$("#submit").click(function(){
			...
			if((!sequence)||($.trim(sequence)=="")){
				...
				clearWarn();
				try{
					var result = fuzzySearchProtein(document);
					$("#result").html(result);
					$("#show").css("display","");
				} catch(e) {
		...
		$("#random").click(function(){
			clearWarn();
			$("#show").css("display","none");
			$.get("data/fuzzySearchProtein.fa","",function(data){
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">Fuzzy Search Protein</a>
     ...
     <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>Introduction：</strong> Fuzzy Search Protein accepts a protein sequence along with a query sequence and returns sites that are identical or similar to the query.
		    	<br />
		    </div>
		</div>
		<div class="row-fluid">
			<div class="span12">
				...
				<p> 
					<form action="" name="main_form" id="main_form">
                    	...
                    	<input type="text" class="input-xlarge" size="30" value="GAD" /><br /><br />
                      ...
                      Gap penalty <select class="span3">
                        <option value="-5">
                          5
                        </option>
                        <option value="-4">
