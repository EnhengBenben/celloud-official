...
public interface UserMapper {
     ...
     */
    public int countUser(@Param("companyId")Integer companyId,@Param("state")Integer state,@Param("testAccountIds")String testAccountIds);
     ...
     */
    public int countCompany(@Param("companyId")Integer companyId,@Param("state")Integer state,@Param("testAccountIds")String testAccountIds);
     ...
     */
    public List<Map<String,Integer>> countCompanyByProvince(@Param("companyId")Integer companyId,@Param("state")Integer state,@Param("testAccountIds")String testAccountIds);
