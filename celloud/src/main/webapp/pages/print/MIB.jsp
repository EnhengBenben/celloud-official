    	...
    	<table class="table table-bordered table-condensed">
			<thead>
               <tr>
                 ...
                 <th style="line-height: 12px;vertical-align: middle;text-align: center;min-width:100px;">种比对上的序列数<br><span style="font-size:12px;color: #9A9999;">Reads_hit</span></th>
                 <th style="line-height: 12px;vertical-align: middle;text-align: center;min-width:100px;">属比对上的序列数<br><span style="font-size:12px;color: #9A9999;">Reads_num</span></th>
                 <th style="line-height: 12px;vertical-align: middle;text-align: center;min-width:80px;">平均覆盖深度<br><span style="font-size:12px;color: #9A9999;">Average depth of coverage</span></th>
               </tr>
             </thead>
		     <tbody>
		       <c:choose>
