...
<!--   <section class="section5 border1 w3cbbs"> -->
  ...
  <section class="section5 border1 w3cbbs" id="section5">
    ...
    <c:forEach items="${cmpReport.geneDetectionDetail }" var="geneDetection" varStatus="size">
    	<h4>${size.count}、&nbsp;&nbsp;${geneDetection.key }基因：该基因突变与${geneDetection.value.result[0].diseaseName }相关</h4>
  ...
  <section class="section7 border1 w3cbbs" id="section5">
    <h4>三. 结果说明</h4>
    <div class="h1">1.关于遗传方式的解释：</div>
    <p>AR，常染色体隐性遗传：理论上存在2个突变位点才可能致病，在只发现一个杂合突变点的时候，虽然为高危致病基因，但定义为致病基因携带者，并不发病。</p>
    <p>AD，常染色体显性遗传：理论上存在1个杂合突变点即导致致病，通常显性遗传临床症状较轻。</p>
    <p>XR ，X染色体隐性遗传：女孩有两条X染色体，男孩只有一条X染色体，通常女孩为致病基因携带者，男孩则发病。</p>
    <p>XD ，X染色体显性遗传：理论上1个杂合或纯合的突变位点均可能致病。</p>
    <div class="h1">2.对经检测发现遗传代谢病致病基因突变的解释：</div>
    <p>这些突变位点在人类基因组突变专业数据库（HGMD）内，有明确文献报道位点与该疾病相关，这样的位点一般经过蛋白功能或家系内的严谨验证，确认为高危致病基因，但不排除少数位点局限于以前的科学水平，属于误报道的高危致病位点。</p>
  	<div class="h1">３.对经检验未发现遗传代谢病致病相关基因突变的解释：</div>
  ...
  <script>
  	function preview(obj){
  		...
  		$("#section5 textarea").each(function(){
