...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/upload.js?version=1.2"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/js/file_upload.js?version=1.2"></script>
