		    ...
		    <div class="center">
		    	<s:if test='soft.isAdd=="yes"'>
	           	...
	           	<s:elseif test='soft.isAdd=="no"'>
	           		<s:if test='soft.softwareId==6||soft.softwareId==9||soft.softwareId==10||soft.softwareId==12||soft.softwareId==74||soft.softwareId==75||soft.softwareId==76||soft.softwareId==77||soft.softwareId==78||soft.softwareId==79||soft.softwareId==81||soft.softwareId==83||soft.softwareId==109||soft.softwareId==110||soft.softwareId==111||soft.softwareId==112||soft.softwareId==113||soft.softwareId==114'>
...
function showMore(){
	...
	$(".detailBtn").html("返回");
	$(".detailBtn").attr("href","javascript:showNomal();");
}
function showNomal(){
	$(".moreInfo").css("display","none");
	$(".nomal").css("display","");
	$(".detailBtn").html("详细");
	$(".detailBtn").attr("href","javascript:showMore();");
}
</script>