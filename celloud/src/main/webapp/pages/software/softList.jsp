			...
			<li class="appGroup">
	         	<div class="app-icon">
	             	...
	             	<div class="center">
		             	...
		             	<s:elseif test='#db.softwareId==6||#db.softwareId==9||#db.softwareId==10||#db.softwareId==12||#db.softwareId==74||#db.softwareId==75||#db.softwareId==76||#db.softwareId==77||#db.softwareId==78||#db.softwareId==79||#db.softwareId==81||#db.softwareId==83||#db.softwareId==109||#db.softwareId==110||#db.softwareId==111'>
					...
					<s:iterator begin="%{pageList.page.totalPage-8}" step="1" end="%{pageList.page.totalPage-1}" var="step">
						<s:if test="#step>1">
							<s:if test="#step==pageList.page.currentPage">
								<li class="active"><a href="javascript:void(0)"><s:property value="#step"/></a></li>
							</s:if>
							<s:else>
