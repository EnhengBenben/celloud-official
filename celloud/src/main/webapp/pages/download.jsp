...
<!--                 <a href="#">意见反馈</a>  -->
    ...
    <div class="main download">
    	<div class="wrapper">
            ...
            <a href="http://client.celloud.org/${client.nameX86 }" class="downloadApp"><img src="images/home/downloadApp.png" />下载客户端</a>
            <h3>客户端安装使用过程中可能出现的问题及解答</h3>
            <p>A.杀毒软件不信任问题<br />
            软件下载后直接解压缩即可使用，使用请把该软件加入杀毒软件可信列表中或者暂时关闭杀毒软件。</p>
            <p>B.软件x86和x64位版本<br />
            软件默认提供x86版本下载，如果您的操作系统是x64位操作系统，也可以<a target="_blank" href="http://client.celloud.org/${client.nameX64 }">【下载x64】</a>位软件。</p>
