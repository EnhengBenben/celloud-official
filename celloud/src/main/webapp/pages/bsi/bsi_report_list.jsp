				...
				<div id="report-list">
				    <table class="table table-main">
				      ...
				      <tbody id="data-list-tbody" ng-if="pageList.datas.length > 0">
				          <tr id="report{{task.dataKey}}{{task.projectId}}{{task.appId}}" ng-repeat="task in pageList.datas" class="{{task.read | reportReadFilter}} {{task.dataKey==thisReport | thisReportFilter}}">
				            <td>
