            ...
            <div id="container" class="container-fluid common-container">
				...
				<div class="pagination text-center" ng-if="pageList.datas.length > 0">
				    ...
				    <ul id="pagination-data" class="pages pull-left">
				      ...
				      <li><a id="next-page-task" class="ends" href="javascript:void(0)" ng-click="paginationBtn(pageList.page.currentPage < pageList.page.totalPage?pageList.page.currentPage+1:pageList.page.totalPage)">&gt;&gt;</a></li>
				    </ul>
