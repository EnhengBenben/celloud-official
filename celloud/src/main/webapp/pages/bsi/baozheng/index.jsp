...
<link href="<%=request.getContextPath()%>/css/bsi.css?version=3.1.15" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script src="<%=request.getContextPath()%>/js/bsi_bz/utils.js?version=1.1" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/js/bsi_bz/bsi_main.js?version=3.1.15" type="text/javascript"></script>
<script src="<%=request.getContextPath() %>/js/bsi_bz/bsi_upload.js?version=3.1.12"></script>
