 	  ...
 	  <table class="table table-main">
        ...
        <div class="pagination text-center" ng-if="taskPageList.datas.length > 0" style="height: 21px;">
            ...
            <ul id="pagination-data-report" class="pages">
                <li><a id="prev-page-task" class="ends pull-left" ng-click="dataInBatch(taskPageList.page.currentPage>1?taskPageList.page.currentPage-1:1)">&lt;&lt;</a></li>
                <!-- 显示第一页 -->
                <li ng-if="taskPageList.page.totalPage <= 3 && step <= taskPageList.page.totalPage" ng-class="{active: step == taskPageList.page.currentPage}" ng-repeat="step in [1,2,3]">
                 ...
                 <a ng-if="step != taskPageList.page.currentPage" name="pagination-task" ng-click="dataInBatch(step)">{{step}}</a>
                </li>
                
                <li ng-if="taskPageList.page.totalPage > 3 && taskPageList.page.currentPage == 1" class="active"><a name="pagination-task">1</a></li>
                <li ng-if="taskPageList.page.totalPage > 3 && taskPageList.page.currentPage == 1"><a name="pagination-task" ng-click="dataInBatch(2)">2</a></li>
                <li ng-if="taskPageList.page.totalPage > 3 && taskPageList.page.currentPage == 1"><a name="pagination-task" ng-click="dataInBatch(3)">3</a></li>
                    
                <li ng-if="taskPageList.page.totalPage > 3 && taskPageList.page.currentPage == taskPageList.page.totalPage"><a name="pagination-task" ng-click="dataInBatch(taskPageList.page.currentPage-2)">{{taskPageList.page.currentPage-2}}</a></li>
                <li ng-if="taskPageList.page.totalPage > 3 && taskPageList.page.currentPage == taskPageList.page.totalPage"><a name="pagination-task" ng-click="dataInBatch(taskPageList.page.currentPage-1)">{{taskPageList.page.currentPage-1}}</a></li>
                ...
                <li ng-if="taskPageList.page.totalPage > 3 && taskPageList.page.currentPage > 1 && taskPageList.page.currentPage < taskPageList.page.totalPage"><a name="pagination-task" ng-click="dataInBatch(taskPageList.page.currentPage-1)">{{taskPageList.page.currentPage-1}}</a></li>
                ...
                <li><a id="next-page-task" class="ends pull-right" ng-click="dataInBatch(taskPageList.page.currentPage < taskPageList.page.totalPage ? taskPageList.page.currentPage + 1 : taskPageList.page.totalPage)">&gt;&gt;</a></li>
            </ul>
          </div>
    </div>
 </div>