    ...
    <header class="common-menu">
        ...
        <div id="common-menu-center" class="info">
            <div id="common-menu" class="common-menu-btn pull-left">
               ...
               <a class="item-btn" ng-class="{active: isActive('product/bactive/data')}" id="to-data-a" di-href="${pageContext.request.contextPath }/index#/product/bactive/data/{{appId}}">
                   <i class="celicon my-data-icon"></i><br>数据
               </a>
               <a class="item-btn" ng-class="{active: isActive('product/bactive/report')}" id="to-report-a" di-href="${pageContext.request.contextPath }/index#/product/bactive/report/{{appId}}">
