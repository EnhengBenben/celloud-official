...
<div class="pagination text-center">
	<ul class="pages pull-left">
      <li class="first-page">
        <a id="prev-page" data-click="pagination-btn" ng-href="#/{{pageType}}/p1">首页{{dataPage}}</a>
      </li>
	</ul>
	<ul id="pagination-ul" class="pages pull-left">
      <!-- 显示prev -->
      <li>
        <a id="prev-page" class="ends" ng-href="#/{{pageType}}/p{{dataList.page.currentPage>1?dataList.page.currentPage-1:1}}">&lt;&lt;</a>
      </li>
      <li ng-class="{active: page==dataList.page.currentPage}" ng-if="dataList.page.totalPage<=7" ng-repeat="page in pageArray(dataList.page.totalPage)">
        <a ng-href="#/{{pageType}}/p{{page}}">{{page}}</a>
      </li>
      ...
      <li ng-if="dataList.page.totalPage>7 && dataList.page.currentPage<=4">
        <a ng-href="#/{{pageType}}/p{{dataList.page.totalPage}}">{{dataList.page.totalPage}}</a>
      </li>
      <li ng-if="dataList.page.totalPage>7 && dataList.page.currentPage>4 && dataList.page.currentPage<dataList.page.totalPage-3">
        <a ng-href="#/{{pageType}}/p1">1</a>
      </li>
      <li ng-if="dataList.page.totalPage>7 && dataList.page.currentPage>4 && dataList.page.currentPage<dataList.page.totalPage-3">
        <a ng-href="javascript:void(0)">…</a>
      </li>
      <li ng-if="dataList.page.totalPage>7 && dataList.page.currentPage>4 && dataList.page.currentPage<dataList.page.totalPage-3">
        <a ng-href="#/{{pageType}}/p{{dataList.page.currentPage-1}}">{{dataList.page.currentPage-1}}</a>
      </li>
      <li class="active" ng-if="dataList.page.totalPage>7 && dataList.page.currentPage>4 && dataList.page.currentPage<dataList.page.totalPage-3">
        <a ng-href="#/{{pageType}}/p{{dataList.page.currentPage}}">{{dataList.page.currentPage}}</a>
      </li>
      <li ng-if="dataList.page.totalPage>7 && dataList.page.currentPage>4 && dataList.page.currentPage<dataList.page.totalPage-3">
        <a ng-href="#/{{pageType}}/p{{dataList.page.currentPage+1}}">{{dataList.page.currentPage+1}}</a>
      </li>
      ...
      <li>
        <a class="ends" ng-href="#/{{pageType}}/p{{dataList.page.currentPage<dataList.page.totalPage ? dataList.page.currentPage+1:dataList.page.totalPage}}">&gt;&gt;</a>
      </li>
    </ul>
    <ul class="pages pull-left">
      <li class="last-page">
        <a ng-href="#/{{pageType}}/p{{dataList.page.totalPage}}">尾页</a>
      </li>
    </ul>
