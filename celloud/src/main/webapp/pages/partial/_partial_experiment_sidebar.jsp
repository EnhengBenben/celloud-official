  ...
  <section class="s-bar">
    <ul class="pro-sidebar-menu" ng-controller="sidebarController">
      ...
      <li ng-class="{active: isActive('/experiment/scanStorage')}">
        <a ng-if="#/experiment/scanStorage"><span>样本入库</span></a>
      </li>
      <li ng-class="{active: isActive('/experiment/tokenDNA')}">
        <a ng-if="#/experiment/tokenDNA"><span>提取DNA</span></a>
      </li>
      <li ng-class="{active: isActive('/experiment/createLibrary')}">
        <a ng-if="#/experiment/createLibrary"><span>文库构建</span></a>
      </li>
      <li ng-class="{active: isActive('/experiment/libraryList')}">
        <a ng-if="#/experiment/libraryList"><span>文库列表</span></a>
      </li>
    </ul>
  </section>
</aside>