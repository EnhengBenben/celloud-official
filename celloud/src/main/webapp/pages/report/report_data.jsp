        ...
        <tbody>
          <tr ng-repeat="task in reportList.datas" class="{{task.read | reportReadFilter}} {{task.dataKey==thisReport | thisReportFilter}}">
            ...
            <td>
              ...
              <a ng-if="task.period == 2 && task.appId < 141 || task.appId > 279" href="#/reportdata/{{task.englishName == '华木兰' ? 'rocky' : task.englishName}}/{{task.appId}}/{{task.dataKey}}/{{task.projectId}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
              <a ng-if="(task.period == 1 || task.isPay == 0) && (task.appId >= 141 && task.appId <= 279)" class="disabled" ><i class="fa fa-eye" aria-hidden="true"></i></a>
              <a ng-if="task.period == 2 && task.isPay == 1 && (task.appId >= 141 && task.appId <= 279)" target="_blank" href="${pageContext.request.contextPath }/report/openPdf/{{task.userId}}/{{task.appId}}/{{task.dataKey}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
            </td>
          </tr>
        </tbody>
      </table>
