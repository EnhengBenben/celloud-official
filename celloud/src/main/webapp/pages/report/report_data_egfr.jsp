    ...
    <div class="content">
      <div class="content-header">
        ...
        <div class="btn-group">
	        ...
	        <a class="btn -right" ng-if="egfr.pdf != null && egfr.pdf != ''" ng-href="${pageContext.request.contextPath }/report/down?path={{egfr.userId}}/{{egfr.appId}}/{{egfr.dataKey}}/{{egfr.pdf}}">PDF下载</a>
        </div>
      </div>
