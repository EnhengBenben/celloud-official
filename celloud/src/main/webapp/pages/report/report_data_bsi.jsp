...
<div class="row rdata-content">
  <div class="col-sm-10">
	  <ul id="myTabs" class="nav nav-tabs" role="tablist">
	    <li role="presentation" ng-class="{active:tab == 'patient'}"><a href="#patient-report" ng-click="tab = 'patient'" id="patient-tab" aria-controls="patient-report" role="tab" data-toggle="tab">患者报告</a></li>
	    <li role="presentation" ng-class="{active:tab == 'analy'}"><a href="#analy-report" ng-click="tab = 'analy'" id="analy-tab" aria-controls="analy-report" role="tab" data-toggle="tab">分析报告</a></li>
	  </ul>
  ...
  <div class="report-opera col-sm-2">
    ...
    <div class="report-btn-group pull-right">
       <a class="btn -low" id="print-patient-a" href="<%=request.getContextPath()%>/report/printBSIReport?projectId={{bsi.projectId}}&dataKey={{bsi.dataKey}}&appId={{bsi.appId}}&templateType=print_patient" target="_blank"><i class="fa fa-print"></i>打印</a>
       ...
       <a class="btn -low" href="javascript:void(0)"><i class="fa fa-cloud-download"></i>导出</a>
	   <a class="btn -low" href="javascript:void(0)"><i class="fa fa-group"></i>发布</a>
	   <a class="btn -low" href="javascript:void(0)"><i class="fa fa-share-square-o"></i>分享</a>
	   <a class="btn -low" href="javascript:void(0)"><i class="fa fa-inbox"></i>存档</a>
     </div>
  </div>
