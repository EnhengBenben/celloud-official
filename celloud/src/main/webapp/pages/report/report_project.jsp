          ...
          <tr ng-repeat="report in dataList.datas" load-over>
            <td>
               ...
               <div class="operate" ng-if="report.userName=='no_one'">
	               ...
	               <a style="padding-right: 20px;" title="PDF下载" ng-if="report.context!=null && report.context!='' && ((report.app_id>84&&report.app_id<89)||(report.app_id>90&&report.app_id<96)||(report.app_id>118&&report.app_id<130&&report.app_id!=126&&report.app_id!=127&&report.app_id!=128&&report.app_id!=123)||report.app_id==104||report.app_id==116)" class="pdfdown" ng-click="downPDF(report.user_id,report.app_id,report.project_id)" href="javascript:void(0)"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
