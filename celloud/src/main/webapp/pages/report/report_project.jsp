          ...
          <tr ng-repeat="report in dataList.datas" load-over>
            <td>
               ...
               <div class="operate" ng-if="report.userName=='no_one'">
	               ...
	               <a style="padding-right: 20px;" title="PDF下载" ng-if="report.context!=null && report.context!='' && ((report.app_id>84&&report.app_id<89)||(report.app_id>90&&report.app_id<96)||(report.app_id>118&&report.app_id<126&&report.app_id!=123)||report.app_id==104||report.app_id==116)" class="pdfdown" ng-click="downPDF(report.user_id,report.app_id,report.project_id)" href="javascript:void(0)" ng-if="report.app_id>84&&report.app_id!=89&&report.app_id!=90&&report.app_id!=105&&report.app_id!=106&&report.app_id!=107&&report.app_id!=108&&report.app_id!=109&&report.app_id!=110&&report.app_id!=111&&report.app_id!=112&&report.app_id!=113&&report.app_id!=114&&report.app_id!=116"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
