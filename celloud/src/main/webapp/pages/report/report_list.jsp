                        ...
                        <c:if test="${report.userName=='no_one'}">
                            <div class="operate">
                                <c:if test="${loginUserInSession.companyId == 6 || loginUserInSession.companyId == 24}">
                                    <a class="projectreport" title="项目报告" target="_blank" onclick="return checkPgsProject(${report.project_id})" href="${pageContext.request.contextPath }/report/printPgsProject?projectId=${report.project_id}"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                </c:if>
