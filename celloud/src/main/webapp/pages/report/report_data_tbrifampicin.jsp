...
<div>
	<div class="m-file">
		...
		<div class="toolbar">
			<a class="btn btn-celloud-success btn-flat" target="_blank" href='report/printHBV?appId=${tbrifampicin.appId }&dataKey=${tbrifampicin.dataKey }&projectId=${tbrifampicin.projectId }'><i class="fa fa-print"></i>打印报告</a>
