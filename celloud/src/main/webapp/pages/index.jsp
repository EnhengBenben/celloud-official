...
<head>
  ...
  <link href="<%=request.getContextPath()%>/css/celloud.min.css?version=3.4.4.04" rel="stylesheet">
...
<body ng-app="celloudApp" ng-controller="sidebarController">
  ...
  <script src="<%=request.getContextPath()%>/js/main.min.js?v=3.4.4.14"></script>
  <script type="text/javascript">
