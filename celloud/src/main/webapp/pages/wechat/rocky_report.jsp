            ...
            <div class="swiper-wrapper">
                ...
                <div class="main swiper-slide">
                    ...
                    <div class="p5_content">
                        <p>风险提示：</p>
                        <p><b>·</b>&nbsp;&nbsp;报告所给出的信息，是作为健康管理的参考信息，不能成为疾病诊断与治疗依据。疾病诊断与治疗需由临床医生给出结论与方案。</p>
                        <p><b>·</b>&nbsp;&nbsp;健康的身体由基因、良好的生活习惯及生活环境共同影响，基因突变本身不是疾病形成的唯一因素。</p>
                        <p><b>·</b>&nbsp;&nbsp;健康，是长期管理的结果，此报告所揭示的突变及相关的信息会因为研究的进展而发生变化。</p>
                        <p>送检样本的处理及数据分析、出具报告的整个过程，都有专业的监管与流程记录，以确保您的个人隐私与相应数据的安全。我们遵从相应的服务协议，在未获得本人授权情况下，数据不作他用。同时也请您妥善保管报告以及相应的数据信息，以免泄漏。</p>
                        <p>祝，健康！</p>
                    </div>
                </div>
                <!--------page6--------->
                ...
                <div class="main swiper-slide">
                    <div class="p7-content">
                        ...
                        <div class="p7">
                            ...
                            <table class="tab_data" border="" cellspacing="" cellpadding="">
                                <thead>
                                    <tr class="tab_header">
                                        <th>编号</th>
                                        <th>基因</th>
                ...
                <div class="main swiper-slide">
                    ...
                    <div class="p8_content">
                        ...
                        <div class="p8_content_top">
                            <img src="<%=request.getContextPath()%>/images/wechat/rocky_report/08.Page 2.png" />
                        </div>
                        <div class="p8_m">
                            参考国际癌症研究机构(International Agency for Research on Cancer,IARC)的分类标准，基因变异的临床意义分类及标准为：
                        </div>
                        <div><b>·</b>致病相关变异：已证实能使癌症风险显著提高的突变。这种变异往往是移码突变，导致蛋白质不能正常表达。</div>
                        <div><b>·</b>可能致病变异：没有明确证据，当前认为该变异有害。</div>
                        <div><b>·</b>意义不明确变异：不确定该变异是有害还是无影响。这是一种常见的检测结果，很多变异一开始都被分为这一类。随着证据的不断补充，这些变异会被重新分类。</div>
                        <div><b>·</b>可能良性变异：没有明确证据，当前认为该变异对人体无害。</div>
                        <div class="p8_m"><b>·</b>良性变异：被证实为对人体无害的变异，可以被认为是“未发生突变”。</div>
                        <div>注：致病相关变异有很高但不完全的遗传外显率，这意味着有害突变携带者有较高的癌变风险，但有的人可能最终并不患癌。</div>
                    </div>
                </div>
                <!--------page9--------->
                <div class="main swiper-slide">
                    <div class="p9-content">
                        <div class="p9_decription">
                            在您的<span id="BCRA">BRCA1/2</span>基因中，BRCA变异影响（临床意义分类）描述如下：
                        </div>
                ...
                <div class="main swiper-slide">
                    ...
                    <div class="p15-content">
                        <p>【1】Holly Yan (2013-05-14). "What's the gene that led to Angelina Jolie's double mastectomy?". Health. CNN.</p>
                        <p>【2】"<span id="BCRA">BRCA1</span> and <span id="BCRA">BRCA2</span>: Cancer Risk and Genetic Testing". National Cancer Institute. 29 May 2009.</p>
                        <p>【3】effrey N. Weitzel, Veronica I. Lagos, Carey A. Cullinane, Patricia J. Gambol, Julie O. Culver, Kathleen R. Blazer, Melanie R. Palomares, Katrina J. Lowstuter, Deborah J. MacDonald (2007). "Limited Family Structure and BRCA Gene Mutation Status
                            in Single Cases of Breast Cancer". Journal of the American Medical Association 297 (23): 2587–2595. doi:10.1001/jama.297.23.2587</p>
                        <p>【4】Cui, J; Antoniou, AC; Dite, GS; Southey, MC; Venter, DJ; Easton, DF; Giles, GG; McCredie, MR; Hopper, JL (Feb 2001)."After <span id="BCRA">BRCA1</span> and <span id="BCRA">BRCA2</span>-what next? Multifactorial segregation analyses of three-generation, population-based Australian families
                            affected by female breast cancer". Am J Hum Genet 68 (2): 420–31. doi:10.1086/318187.PMC 1235275. PMID 11133358</p>
                        <p>【5】Morris, Joi L.; Gordon, Ora K. (2010). Positive Results: Making the Best Decisions When You're at High Risk for Breast or Ovarian Cancer. Amherst, N.Y.: Prometheus Books. ISBN 978-1-59102-776-8.</p>
                        <p>【6】Campeau PM, Foulkes WD, Tischkowitz MD. Hereditary breast cancer: New genetic developments, new therapeutic avenues. Human Genetics 2008; 124(1):31–42.</p>
                        <p>【7】Easton DF. How many more breast cancer predisposition genes are there? Breast Cancer Research 1999; 1(1):14–17.  [PubMed Abstract]</p>
                        <p>【8】Pal T, Permuth-Wey J, Betts JA, et al. <span id="BCRA">BRCA1</span> and <span id="BCRA">BRCA2</span> mutations account for a large proportion of ovarian carcinoma cases. Cancer 2005; 104(12):2807–16.</p>
                        <p>【9】Howlader N, Noone AM, Krapcho M, et al. (eds). SEER Cancer Statistics Review, 1975-2011, National Cancer Institute. Bethesda, MD, http://seer.cancer.gov/csr/1975_2011/, based on November 2013 SEER data submission, posted to the SEER web site,
                            April 2014.</p>
                        <p>【10】Antoniou A, Pharoah PD, Narod S, et al. Average risks of breast and ovarian cancer associated with <span id="BCRA">BRCA1</span> or <span id="BCRA">BRCA2</span> mutations detected in case series unselected for family history: A combined analysis of 22 studies. American Journal of Human Genetics2003;
                            72(5):1117–1130.</p>
                        <p>【11】Chen S, Parmigiani G. Meta-analysis of <span id="BCRA">BRCA1</span> and <span id="BCRA">BRCA2</span> penetrance. Journal of Clinical Oncology 2007; 25(11):1329–1333.</p>
                    </div>
                </div>
                <!--------page16--------->
                <div class="main swiper-slide">
