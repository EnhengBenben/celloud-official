...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/wechat/rocky_report.css?v=2.6" />
    </head>
    ...
    <body>
        ...
        <script src="<%=request.getContextPath()%>/js/rote.js?v=3.2" type="text/javascript" charset="utf-8"></script>
    </body>
</html>