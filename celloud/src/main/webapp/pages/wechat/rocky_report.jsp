...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/wechat/rocky_report.css?v=1.9" />
    </head>
    ...
    <body>
        ...
        <script src="<%=request.getContextPath()%>/js/rote.js?v=2.0" type="text/javascript" charset="utf-8"></script>
    </body>
</html>