			...
			<header class="common-menu">
				...
				<div name="sample-condition" class="info hide">
					...
					<div id="sample-error" class="errortip hide">
						<p>
							此样品信息已经收集过，请核查或者采集下一管样品信息！
							<a id="close-error" href="javascript:void(0)">
				...
				<div class="searchs">
					...
					<div name="sample-condition" class="btns hide">
						<a id="sample-cancel" class="btn -cancel -lg">取消</a>
						<a id="sample-commit" class="btn -confirm -lg">提交样本信息</a>
					</div>
				</div>
				<hr class="-right">
			</header>
