...
<div class="pagination text-center">
  ...
  <ul id="pagination-ul" class="pages pull-right">
    ...
    <li><a name="pagination-info" href="javascript:void(0)">2</a></li>
    <li><a name="pagination-info" href="javascript:void(0)">3</a></li>
    <li><a name="pagination-info" href="javascript:void(0)">4</a></li>
    <li><a name="pagination-info" href="javascript:void(0)">5</a></li>
    <li><a name="pagination-info" href="javascript:void(0)">6</a></li>
    <li><a name="pagination-info" href="javascript:void(0)">7</a></li>
    <li><a id="next-page" class="ends" href="javascript:void(0)">&gt;&gt;</a></li>
  </ul>
</div>