	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">TB-Rifampicin</a>
          <div class="">
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>介绍：</strong> TB-Rifampicin耐药基因检测分析系统是针对结核分枝杆菌基因突变检测试剂盒（PCR-测序法）开发的分析软件，读取序列结果，检测利福平耐药基因rpoB序列中的507-533位突变。
		    	<br />
		    </div>
		</div>
