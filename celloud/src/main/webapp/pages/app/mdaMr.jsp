	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">MDA_MR</a>
          <div class="">
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>介绍：</strong> MDA_MR胚胎染色体异倍性分析是针对人类胚胎基因组二代测序数据，检测胚胎染色体数目畸变的分析软件。基于隐马尔克夫模型（Hidden Markov Model，HMM）对二代测序数据进行分析，软件读取序列比对格式（bam）文件，通过基因组各染色体不同位置比对序列数量，计算得出染色体不同片段的拷贝数，为临床诊断提供参考依据。
		    	<br />
		    </div>
		</div>
