	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">NIPT</a>
          <div class="">
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>介绍：</strong>无创产前检测分析系统是针对母体血液中胎儿游离DNA二代测序数据, 检测胎儿13,18,21号染色体是否为三倍体的分析软件。软件读取二代 测序数据（bam）文件，根据比对到特定染色体的序列数量，进行Z检 验分析，评估胎儿染色体拷贝数，检测结果可以为产前筛查和诊断提 供参考，提高临床检验效率。
		    	<br />
		    </div>
		</div>
