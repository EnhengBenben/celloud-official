	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="javascript:void(0)">HCV_Genotype</a>
          <div class="">
    ...
    <div class="container-fluid">
    	<div class="row-fluid">
			<div class="alert alert-info">
		    	<strong>介绍：</strong> 根据全基因组比对的进化关系，HCV分为6种基因型。该APP使用phred 及phd2fasta将测序峰图文件转化为序列，通过与6种基因型的HCV基因组blast比对， 得到每条序列的基因型信息。
		    	<br />
		    </div>
		</div>
