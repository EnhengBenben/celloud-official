      ...
      <table class="table table-main" ng-init="pageType='expense/consume'">
        ...
        <tbody>
          <tr ng-repeat="expense in dataList.datas">
            ...
            <td title="数据{{expense.fileInfos}}运行{{expense.appName}}">数据{{expense.fileInfos.length > 45 ? expense.fileInfos.substring(0, 45) + "..." : expense.fileInfos}}运行{{expense.appName}}</td>
            <td>{{expense.price}}</td>
