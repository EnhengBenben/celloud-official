...
<link href="<%=request.getContextPath() %>/css/data.css?v=20150526" rel="stylesheet">
<!-- 数据报告视图table hidden -->
...
<script src="<%=request.getContextPath()%>/js/data.js?version=20150702" type="text/javascript"></script>
<!-- spin:loading效果 end-->
