...
var plupload = {
	...
	*/
	 ...
	 * @return {String} Formatted size string.
	 */
	formatDate : function(size) {
		var ss = parseInt(size);// 秒
		if (ss === undef || /\D/.test(ss)) {
			return plupload.translate('N/A');
		}
		var radix = 60;
	    var mm = 0;// 分
...
//			onlyName = file.lastModifiedDate.format("yyyyMMddhhmmss")+file.size+file.name;
