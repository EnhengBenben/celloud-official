  ...
  e.fn.smartZoom = function(t) {
    ...
    function d(t) {
      ...
      if (i.touch.touchMove) {
        ...
        if (i.settings.dblTapEnabled == true && i.touch.lastTouchEndTime != 0
    ...
    function g(t) {
      ...
      if (r.transitionObject) {
        ...
        if (r.transitionObject.css3dSupported) {
          o[r.transitionObject.transform] = "translate3d(" + s.x + "px, " + s.y
              + "px, 0) scale3d(" + s.width / i.width + "," + s.height
              / i.height + ", 1)"
        } else {
          o[r.transitionObject.transform] = "translateX(" + s.x
              + "px) translateY(" + s.y + "px) scale(" + s.width / i.width
              + "," + s.height / i.height + ")"
        }
        n.css(o)
      } else {
    ...
    function w() {
      ...
      var a = L(t);
      var f = Math.min(Math.min(a.width / r.width, a.height / r.height), 1)
          .toFixed(2);
      var l = r.width * f;
      var c = r.height * f;
      e.adjustedPosInfos = {
    ...
    function E(t, r, i, s, o, u, a) {
      ...
      var c = r - l.left;
      var h = i - l.top;
      var h = i - (l.top - $(document).scrollTop());
      if (f.transitionObject != null) {
        ...
        if (f.transitionObject.css3dSupported)
          d[f.transitionObject.transform] = "translate3d(" + c + "px, " + h
              + "px, 0) scale3d(" + s / p.width + "," + o / p.height + ", 1)";
        else
          d[f.transitionObject.transform] = "translateX(" + c
              + "px) translateY(" + h + "px) scale(" + s / p.width + "," + o
              / p.height + ")";
        if (a != null) {
...
//      }
    ...
    var i = {
      init : function(t) {
        ...
        var u = e('<div id="' + i + '" class="' + settings.containerClass
            + '"></div>');
        n.before(u);
        n.remove();
        u = e("#" + i);
