...
$.sample = {
    main: function(){
      $("#container").load("pages/bsi/baozheng/sample_main.jsp",function(){
        $.sample.sampleList();
    ...
    sampleList: function(){
      $.get("sample/baozheng/bsi/sampleList",{},function(response){
...
$.report = {
  ...
  find: {
    main: function(type){
      $.get("report/baozheng/bsi/reportMain",function(response){
    ...
    all: function(){
      $.get("report/baozheng/bsi/reportList",function(response){
    ...
    condition: function(){
      ...
      $.get("report/baozheng/bsi/searchReportList",{"sampleName":options.sampleName,"batch":options.batch,"period":options.period,"beginDate":options.beginDate,"endDate":options.endDate,"condition":options.condition,"sort":options.sort,"sortDate":options.sortDate,"sortPeriod":options.sortPeriod,"sortBatch":options.sortBatch,"sortName":options.sortName,"size":options.pageSize},function(response){
        $.report.loadlist(response);
      });
    },
    pagination: function(currentPage){
      var options = $.report.options;
      $.get("report/baozheng/bsi/searchReportList",{"sampleName":options.sampleName,"batch":options.batch,"period":options.period,"beginDate":options.beginDate,"endDate":options.endDate,"page":currentPage,"condition":options.condition,"sort":options.sort,"sortDate":options.sortDate,"sortPeriod":options.sortPeriod,"sortBatch":options.sortBatch,"sortName":options.sortName,"size":options.pageSize},function(response){
        $.report.loadlist(response);
      });
    }
  },
  ...
  detail: {
    ...
    patient: function(dataKey,projectId,appId,reportIndex,currentPage){
      var options = $.report.options;
      $.post("report/baozheng/getBSIPatientReport",{"sampleName":options.sampleName,"reportIndex":reportIndex,"dataKey":dataKey,"projectId":projectId,"appId":appId,"page":currentPage,"condition":options.condition,"sort":options.sort,"sortDate":options.sortDate,"sortPeriod":options.sortPeriod,"sortBatch":options.sortBatch,"sortName":options.sortName,"size":options.pageSize},function(response){
        $("#container").html(response);
      });
    },
    analy: function(dataKey,projectId,appId){
      $.get("report/baozheng/getBSIAnalyReport",{"dataKey":dataKey,"projectId":projectId,"appId":appId},function(response){
    ...
    prev: function(currentPage){
      if(currentPage > 1){
        var options = $.report.options;
        $.post("report/baozheng/getPrevOrNextBSIReport",{"sampleName":options.sampleName,"batch":options.batch,"period":options.period,"beginDate":options.beginDate,"endDate":options.endDate,"isPrev":true,"page":currentPage-1,"condition":options.condition,"sort":options.sort,"sortDate":options.sortDate,"sortPeriod":options.sortPeriod,"sortBatch":options.sortBatch,"sortName":options.sortName},function(response){
    ...
    next: function(currentPage){
      ...
      if(currentPage < totalPage){
        var options = $.report.options;
        $.post("report/baozheng/getPrevOrNextBSIReport",{"sampleName":options.sampleName,"batch":options.batch,"period":options.period,"beginDate":options.beginDate,"endDate":options.endDate,"isPrev":false,"page":currentPage+1,"totalPage":totalPage,"condition":options.condition,"sort":options.sort,"sortDate":options.sortDate,"sortPeriod":options.sortPeriod,"sortBatch":options.sortBatch,"sortName":options.sortName},function(response){
          if(response != null &&response !=""){
            $("#container").html(response);
          }
        });
...
$.data_ = {
    ...
    find : {
        all: function(){
          $.get("data/baozheng/bsiDataList",function(response){
            $.data_.loadlist(response);
          });
        },
        condition: function(){
          var options = $.data_.options;
          $.get("data/baozheng/bsiDataList",{"batch":options.batch,"period":options.period,"beginDate":options.beginDate,"endDate":options.endDate,"condition":options.condition,"sort":options.sort,"sortDate":options.sortDate,"sortBatch":options.sortBatch,"sortName":options.sortName,"size":options.pageSize},function(response){
            $.data_.loadlist(response);
          });
        },
        pagination: function(currentPage){
          var options = $.data_.options;
          $.get("data/baozheng/bsiDataList",{"page":currentPage,"condition":options.condition,"sort":options.sort,"sortDate":options.sortDate,"sortBatch":options.sortBatch,"sortName":options.sortName,"size":options.pageSize},function(response){
            $.data_.loadlist(response);
          });
        }
    },
