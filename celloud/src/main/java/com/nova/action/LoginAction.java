...
@Action("login")
@Results({ @Result(name = "success", location = "/loadIndex.jsp"), @Result(name = "input", location = "/index.jsp"),
        @Result(name = "home", location = "/pages/celloud.jsp"), @Result(name = "toLogin", location = "/index.jsp"),
    ...
    public String login() {
        ...
        if (checked) {
            ...
            if (!"".equals(request.getParameter("info"))) {
                ...
                if (kaptchaExpected == null || !kaptchaExpected.equalsIgnoreCase(user.getKaptchaCode())) {
