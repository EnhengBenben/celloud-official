...
public class PythonServiceImpl implements IPythonService {
    ...
    @Override
    public int threadSave(int id, String dataKey, long num, long position) {
        return sql.threadSave(id, dataKey, num, position);
    }

    @Override
    public int threadUpdate(int id, String dataKey, long num, long position) {
        return sql.threadUpdate(id, dataKey, num, position);
    }

    @Override
    public String threadRead(int id, String dataKey) {
        return sql.threadRead(id, dataKey);
    }
}
