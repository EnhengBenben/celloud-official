...
public class NoticeServiceImpl implements NoticeService {
	...
	public void readAllMessage() {
		noticeMapper.readAll(ConstantsData.getLoginUserId(), NoticeConstants.TYPE_MESSAGE);
	}

	@Override
	public void readAllNotice() {
		noticeMapper.readAll(ConstantsData.getLoginUserId(), NoticeConstants.TYPE_NOTICE);
	}
