...
public interface TaskMapper {
	 ...
	 */
	int updatePeriodByProAndData(@Param("projectId") Integer projectId, @Param("dataKey") String dataKey,
	 ...
	 */
	Task findFirstTaskByAppId(@Param("appId") Integer appId, @Param("period") Integer period,
	 ...
	 */
	Integer findAppRunningNum(@Param("appId") Integer appId, @Param("period") Integer period,
			@Param("state") Integer state);
	 ...
	 */
	Integer findAppsRunningNum(@Param("appIds") List<Integer> appIds, @Param("period") Integer period,
			@Param("state") Integer state);
	 ...
	 */
	Task findTaskByProData(@Param("projectId") Integer projectId, @Param("dataKey") String dataKey);
	 ...
	 */
	List<Task> findTasksByUser(Page page, @Param("userId") Integer userId, @Param("state") Integer state,
	...
	List<Task> findTasksByUserCondition(Page page, @Param("userId") Integer userId,
			...
			@Param("sortPeriod") String sortPeriod, @Param("state") Integer state, @Param("batch") String batch,
			@Param("period") String period, @Param("beginDate") String beginDate, @Param("endDate") String endDate,
			@Param("appId") Integer appId, @Param("sampleName") String sampleName);
	 ...
	 * @return
	 */
	List<Task> findTasksByBatch(Page page, @Param("userId") Integer userId, @Param("appId") Integer appId,
	 ...
	 */
	Task findTaskByDataKeyAndApp(@Param("state") Integer state, @Param("dataKey") String dataKey,
	 ...
	 */
	Task findTaskDataAppPro(@Param("state") Integer state, @Param("dataKey") String dataKey,
			@Param("appId") Integer appId, @Param("projectId") Integer projectId);
	 ...
	 */
	List<Map<String, Object>> findTaskPeriodNum(@Param("state") Integer state, @Param("appId") Integer appId,
	...
	List<Task> findTaskAndDataInfo(Page pager, @Param("userId") Integer userId, @Param("state") Integer state,
			@Param("condition") String condition, @Param("tagId") Integer tagId, @Param("batch") String batch,
			@Param("period") Integer period, @Param("beginDate") String beginDate, @Param("endDate") String endDate,
			@Param("sord") String sord);

	List<String> findDataKeys(@Param("userId") Integer userId, @Param("state") Integer state,
			@Param("appId") Integer appId, @Param("proId") Integer proId, @Param("params") String params);
