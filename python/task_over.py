...
# command: python *.py basePath projectId dataKey
# eg : python task_over.py '/share/data/webapps/Tools/upload/' 88 110 20151119290394,20151119898677
...
if len(sys.argv) != 5:
    print 'Usage: *.py path userId appId dataKeys'
    sys.exit(0)
path = sys.argv[1]
userId = sys.argv[2]
appId = sys.argv[3]
