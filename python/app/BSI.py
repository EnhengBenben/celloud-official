        ...
        if os.path.exists(normal_species_path):
            ...
            for line in f.readlines():
                ...
                if seq1 is not None:
                    ...
                    seq1_text = list_value(seq1list, 1)
                ...
                if seq2 is not None:
                    ...
                    seq2_text = list_value(seq2list, 1)
                ...
                if seq3 is not None:
                    ...
                    seq3_text = list_value(seq3list, 1)
                ...
                if seq4 is not None:
                    ...
                    seq4_text = list_value(seq4list, 1)
                species = {"species": specie_name, "species_zh": species_zh,
                           ...
                           "seq1_name": seq1_name, "seq1": seq1_text,
                           "seq2_name": seq2_name, "seq2": seq2_text,
                           "seq3_name": seq3_name, "seq3": seq3_text,
                           "seq4_name": seq4_name, "seq4": seq4_text,
