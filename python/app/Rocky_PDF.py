...
class RockyPdf:
    ...
    def createPDF(self, objId):
        ...
        self.drawPara(examineeName,ps,c,84,14,166,669)
        page2_icon2.drawOn(c,323,679)
        self.drawPara('出生年月：',ps,c,70,14,343,669)
        self.drawPara(birthday,ps,c,84,14,418,669)
        c.line(95,668,550,668)
        self.drawPara('样本类型：',ps,c,70,14,95,614)
        self.drawPara(sampleType,ps,c,70,14,170,614)
        self.drawPara('样本编号：',ps,c,70,14,323,614)
        self.drawPara(sampleId,ps,c,70,14,398,614)
        self.drawPara('送检日期：',ps,c,70,14,95,580)
        self.drawPara(detectionDate,ps,c,70,14,170,580)
        self.drawPara('报告日期：',ps,c,70,14,323,580)
        self.drawPara(reportDate,ps,c,70,14,398,580)
