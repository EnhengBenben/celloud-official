...
class RockyPdf:
    ...
    def getDescription(self):
        ...
        return data
    # create pdf
    def createPDF(self,path,dataKey,companyId):
        peakPath = os.path.join(path,dataKey+"/")
        px = os.path.join(PDFPro.rockyPath,"pic/"+"px.png")
        end = Image(os.path.join(PDFPro.rockyPath,"pic/"+"end.png"),5,4)
        end2 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"end2.png"),11,12)
        page1_logo = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page1_logo.png"),347,52)
        page1_celloud = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page1_celloud.png"),181,14)
        page1_yanda = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page1_yanda.png"),122,29)
        page2_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page2_title.png"),238,38)
        page2_icon1 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page2_icon1.png"),13,12)
        page2_icon2 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page2_icon2.png"),12,12)
        page3 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page3.png"),595,802)
        page4_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page4_title.png"),120,40)
        page6_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page6_title.png"),104,40)
        page6_content = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page6_content.png"),208,220)
        page8_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page8_title.png"),150,53)
        page8_content = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page8_content.png"),400,79)
        page9_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page9_title.png"),146,55)
        page9_content2 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page9_content2.png"),337,149)
        page10_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page10_title.png"),132,53)
        page10_content = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page10_content.png"),318,261)
        page11_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page11_title.png"),226,53)
        page11_content = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page11_content.png"),250,252)
        page12_content = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page12_content.png"),300,300)
        page13_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page13_title.png"),225,52)
        page13_icon1 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page13_icon1.png"),13,15)
        page13_icon2 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page13_icon2.png"),14,14)
        page13_icon3 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page13_icon3.png"),13,15)
        page13_icon4 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page13_icon4.png"),14,13)
        page14_icon1 = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page14_icon1.png"),12,14)
        page15_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page15_title.png"),97,40)
        page16_title = Image(os.path.join(PDFPro.rockyPath,"pic/"+"page16_title.png"),116,40)
        celloud = Image(os.path.join(PDFPro.rockyPath,"pic/"+"celloud.png"),222,82)
        # 读取结果文件
        ...
        c = canvas.Canvas(os.path.join(path,dataKey,dataKey+'.pdf'),pagesize=A4)
        c.setFont('pf1',14)
        # 第一页
